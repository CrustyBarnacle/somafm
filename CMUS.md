These instructions apply to the previous versions/releases of the somafm script.
A flat file of *.pls (URLs to playlists) was created that was readable/useable by cmus.

The `write_pls()` function can still be used to output that same flat list, but development has moved to supporting MPD.

# somafm

Short Python script that grabs the SomaFM channels information from https://somafm.com/channels.json, and prints out a list of the highest quality aac format playlists. Useful for creating a playlist for your favorite stream-capable music player (cmus - https://cmus.github.io/).
